...
public:
    ...
    {
        _cmd={
            std::vector<float>( param.dof_nums, 0.0f ), // 位置指令
            std::vector<float>( param.dof_nums, 0.0f ), // 速度指令
            std::vector<float>( param.dof_nums, 0.0f ), // 力矩指令
            std::vector<float>( param.dof_nums, 0.0f ), // kp指令
            std::vector<float>( param.dof_nums, 0.0f ), // kd指令
        };
    }; 
